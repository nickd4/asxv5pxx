...
cd as78k0
@echo on
%MS$DEV% as78k0.dsw /MAKE "as78k0 - Win32 Release" /REBUILD /OUT as78k0.log
@echo off
type as78k0.log
cd ..
cd as78k0s
...
cd as8008
@echo on
%MS$DEV% as8008.dsw /MAKE "as8008 - Win32 Release" /REBUILD /OUT as8008.log
@echo off
type as8008.log
cd ..
cd as8008s
@echo on
%MS$DEV% as8008s.dsw /MAKE "as8008s - Win32 Release" /REBUILD /OUT as8008s.log
@echo off
type as8008s.log
cd ..
cd as8048
...
cd as89lp
@echo on
%MS$DEV% as89lp.dsw /MAKE "as89lp - Win32 Release" /REBUILD /OUT as89lp.log
@echo off
type as89lp.log
cd ..
cd as8x300
@echo on
%MS$DEV% as8x300.dsw /MAKE "as8x300 - Win32 Release" /REBUILD /OUT as8x300.log
@echo off
type as8x300.log
cd ..
cd as8xcxxx
...
cd asz280
@echo on
%MS$DEV% asz280.dsw /MAKE "asz280 - Win32 Release" /REBUILD /OUT asz280.log
@echo off
type asz280.log
cd ..
cd aslink
...
echo as8008    as8008s   as8048    as8051    as8085    as89lp
echo as8x300   as8xcxxx  asavr     ascheck   asez80    asf2mc8
echo asf8      asgb      ash8      asm8c     aspic     asrab
echo asscmp    asst6     asst7     asst8     asz8      asz80
echo asz280
echo --------  --------  --------  --------  --------  --------
