...
extern	int	zflag;		/*	-z, disable symbol case sensitivity
				 */
extern	int	bytesflag;	/*	-234, increase address length to at least n
				 */
...
extern	FILE *		afile();
extern	VOID		afilex();
extern	char *		argvscan();
extern	VOID		asexit();
extern	VOID		asmbl();
extern	VOID		boundary);
extern	VOID		equate();
extern	char *		filespec();
extern	VOID		fixrelfil();
extern	int		fndidx();
extern	int		intsiz();
extern	VOID		insline();
/*
...
extern	char *		fgetm();
extern	VOID		getdarg();
extern	VOID		getdfarg();
extern	VOID		getinline();
extern	VOID		getxarg();
extern	VOID		getxnum();
extern	VOID		getxstr();
extern	VOID		macro();
